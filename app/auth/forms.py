...
from wtforms.validators import Email, EqualTo, Length, Optional, Regexp, Required
...
class RegistrationForm(FlaskForm):
    ...
    organisation = StringField('Organisation or company (optional)', validators=[Optional()])
